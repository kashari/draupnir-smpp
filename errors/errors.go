...
var (
	...
	ErrShortMessageLengthTooLarge error = &SmppErr{err: fmt.Sprintf("Encoded short message data exceeds size of %d", constants.SM_MSG_LEN), serialVersionUID: 78237205927624}
